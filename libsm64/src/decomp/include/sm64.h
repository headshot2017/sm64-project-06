...
#define ACT_CUSTOM_ANIM                0x0000133E // (0x13E | ACT_FLAG_STATIONARY | ACT_FLAG_INTANGIBLE) (custom libsm64 GTA SA action)
#define ACT_CUSTOM_ANIM_TO_ACTION      0x0000133F // (0x13F | ACT_FLAG_STATIONARY | ACT_FLAG_INTANGIBLE) (custom libsm64 GTA SA action)
